...
// Task 20
// The resetForm function is called when the "Reset" button is pressed
// It clears all input fields and the output area
function resetForm() {
    FORM_NAME_FIELD.innerHTML = "";
    AGE_FIELD.innerHTML = "";
    RATING_FIELD.innerHTML = "";
    MONEY_FIELD.innerHTML = "";
    OUTPUT.innerHTML = "The output of your script will go here.";
